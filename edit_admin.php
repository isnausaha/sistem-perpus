    ...
    <div class="card shadow-lg p-3 mb-5">
        <div class="card-body">
            ...
            <form action="" method="POST">
                ...
                <br>
                <button type="submit" name="simpan" class="btn btn-info">perbarui</button>
            </form>
        </div>
    </div>
</div>
<?php
    if (isset($_POST['simpan'])) {
        ...
        if ($query) {
            ...
            echo "<script>location='main.php?hal=data_admin'</script>";
        }else{
            echo "<script>alert('data gagal diedit')</script>";
            echo "<script>location='main.php?hal=edit_admin'</script>";
        }
    }
?>